...
enum AppAuthResponseCode: string implements AppAuthEnumCodeContract {
    ...
    case RoleInactive = 'role_inactive';
    ...
    case UserProfileMismatch = 'user_profile_mismatch';
    case CompanyNotFound = 'company_not_found';
    case CompanyMismatch = 'company_mismatch';
    case CompanyInactive = 'company_inactive';
    case CompanyUnpaid = 'company_unpaid';
    case CompanyExpired = 'company_expired';
    case CompanySuspended = 'company_suspended';
    case CompanyTrialExpired = 'company_trial_expired';
    case CompanyPaidExpired = 'company_paid_expired';
    case CompanyBillingInvalid = 'company_billing_invalid';
    case CompanyConfigAuthNotFound = 'company_config_auth_not_found';
    case CompanyConfigAuthMissing = 'company_config_auth_missing';
    case LinkVerificationExpired = 'link_verification_expired';
    ...
    public function getStatusCode(): int {
        return match ($this) {
            ...
            self::UsernameAlreadyExists => 409,
            self::RoleNotFound => 404,
            self::UserProfileMismatch => 401,
            self::CompanyNotFound => 404,
            self::CompanyMismatch => 401,
            self::CompanyInactive => 403,
            self::CompanyUnpaid => 403,
            self::CompanyExpired => 403,
            self::CompanySuspended => 403,
            self::CompanyTrialExpired => 403,
            self::CompanyPaidExpired => 403,
            self::CompanyBillingInvalid => 403,
            self::CompanyConfigAuthNotFound => 403,
            self::CompanyConfigAuthMissing => 403,
            self::LinkVerificationExpired => 403,
