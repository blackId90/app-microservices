...
trait LogAudit {
    ...
    public static function logAudit(AppControlCenterException $appControlCenterException, string $level, string $message, array $extraContext = []): void {
        $request = request();
        ...
        $httpStatusCode = $appControlCenterException->getCode();
        $errorFile = $appControlCenterException->getFile();
        $errorLine = $appControlCenterException->getLine();

        $trace = collect($appControlCenterException->getTrace())->map(function ($t) {
    ...
    public static function notifyAudit(AppControlCenterException $appControlCenterException, string $level, string $message): void {
        $request = request();
